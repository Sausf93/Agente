 ...
 * con un campo del agente (norma, articulo, importe, gravedad, hecho, puntos) prerrellenan el
 * formulario; los datos de terceros nunca llegan por aquí.
 */

/** Claves de prefill admitidas desde la ficha (solo campos del agente). */
const CLAVES_PREFILL = ['norma', 'articulo', 'importe', 'gravedad', 'hecho', 'puntos'] as const;
