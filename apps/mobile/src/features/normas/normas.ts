...
export const SUBTEMA_POR_INFRACCION: Record<string, SubTemaId> = {
  ...
  // 2ª ola de tráfico (2026-09-11): aparcamiento desglosado y conductas frecuentes.
  'inf-doble-fila': 'traf-estacionamiento',
  'inf-estacionar-paso-peatones': 'traf-estacionamiento',
  'inf-estacionar-vado': 'traf-estacionamiento',
  'inf-estacionar-pmr-sin-tarjeta': 'traf-estacionamiento',
  'inf-estacionar-carga-descarga': 'traf-estacionamiento',
  'inf-sin-chaleco-triangulos-v16': 'traf-estado-vehiculo',
  'inf-alumbrado-tunel': 'traf-estado-vehiculo',
  'inf-remolque-mal-enganchado': 'traf-estado-vehiculo',
  ...
  // 4ª ola de tráfico (2026-09-14): Reglamento de Conductores, VMP desglosado, titular, placas,
  // bajas e ITV. Cada ficha nueva debe llevar sub-tema (lo exige el test de cobertura).
  'inf-permiso-clase-inadecuada': 'traf-documentacion',
  'inf-permiso-caducado-reconocimiento': 'traf-documentacion',
  'inf-conductor-novel-sin-l': 'traf-documentacion',
  'inf-permiso-extranjero-no-valido': 'traf-documentacion',
  'inf-titular-no-identifica-conductor': 'traf-documentacion',
  'inf-sin-placa-o-no-reglamentaria': 'traf-documentacion',
  'inf-vehiculo-dado-baja': 'traf-documentacion',
  'inf-vmp-acera': 'traf-estacionamiento',
  'inf-vmp-pasajero': 'traf-estacionamiento',
  ...
  'del-acoso-sexual': 'pen-sexual',
  'del-prostitucion-coactiva': 'pen-sexual',
  ...
  'del-estafa-tarjeta': 'pen-patrimonio',
  ...
  'del-danos-leves': 'pen-patrimonio',
  'del-falsificacion-tarjetas': 'pen-patrimonio',
  ...
  'del-deposito-armas-guerra': 'pen-otros',
  'del-falsificacion-moneda': 'pen-otros',
  'del-intrusismo': 'pen-otros',
  ...
  // Seguridad ciudadana — olas de paridad SPPLB (2026-09-14): arts. 35/36/37 LO 4/2015 + armas RD 137/1993.
  'sc-negativa-disolver-reunion': 'seg-reuniones',
  'sc-perturbar-reunion-licita': 'seg-reuniones',
  'sc-espectaculo-prohibido': 'seg-reuniones',
  'sc-perturbacion-sedes-parlamentarias': 'seg-reuniones',
  'sc-restriccion-circulacion-actos': 'seg-reuniones',
  'sc-obstruir-servicios-emergencia': 'seg-orden-identidad',
  'sc-intrusion-infraestructuras': 'seg-orden-identidad',
  'sc-uso-indebido-uniforme': 'seg-orden-identidad',
  'sc-laser-conductores-pilotos': 'seg-orden-identidad',
  'sc-laser-agentes': 'seg-orden-identidad',
  'sc-danos-deslucimiento-bienes': 'seg-orden-identidad',
  'sc-escalada-edificios': 'seg-orden-identidad',
  'sc-obstruccion-ejercicio-funciones': 'seg-orden-identidad',
  'sc-obstruccion-inspecciones-controles': 'seg-orden-identidad',
  'sc-falta-colaboracion-fcs': 'seg-orden-identidad',
  'sc-datos-falsos-documentacion': 'seg-orden-identidad',
  'sc-remocion-precinto-perimetro': 'seg-orden-identidad',
  'sc-tolerancia-drogas-local': 'seg-drogas-armas',
  'sc-traslado-facilitar-drogas': 'seg-drogas-armas',
  'sc-cultivo-drogas-visible': 'seg-drogas-armas',
  'sc-exhibicion-objetos-peligrosos': 'seg-drogas-armas',
  'arma-coleccionismo-sin-autorizacion': 'seg-drogas-armas',
  'arma-no-comunicar-perdida-arma': 'seg-drogas-armas',
  ...
  // Animales — olas de paridad SPPLB (2026-09-14): PPP (Ley 50/1999) y bienestar (Ley 7/2023).
  'ppp-abandono': 'anim-ppp',
  'ppp-adiestramiento-ataque': 'anim-ppp',
  'ppp-criar-comerciar-sin-autorizacion': 'anim-ppp',
  'ppp-sin-cartel-advertencia': 'anim-ppp',
  'ppp-no-comunicar-incidencias': 'anim-ppp',
  'ppp-suelto-sin-bozal-ni-correa': 'anim-ppp',
  'animal-dejar-sin-atencion': 'anim-bienestar',
  'animal-no-vacunar-desparasitar': 'anim-bienestar',
  'animal-sacrificio-injustificado': 'anim-bienestar',
  'animal-tenencia-tras-inhabilitacion': 'anim-bienestar',
  'animal-transporte-inadecuado': 'anim-bienestar',
  'animal-mendicidad': 'anim-bienestar',
  'animal-uso-espectaculos': 'anim-bienestar',
  'animal-metodos-crueles': 'anim-bienestar',
  'animal-venta-ilegal': 'anim-bienestar',
  'animal-especie-no-permitida': 'anim-bienestar',
  'animal-perro-suelto-sin-control': 'anim-otras',
  'animal-sin-curso-ni-seguro': 'anim-otras',
